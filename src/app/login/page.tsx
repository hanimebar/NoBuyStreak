      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2 mb-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-border text-foreground px-4 py-2.5 text-sm font-mono hover:border-amber hover:text-amber transition"
          >
